...
- **Новый e-mail** (`ufCrm8_1765129812542`) - ✅ используется в конфиге
- **Новый телефон** (`ufCrm8_1765129827038`) - ✅ используется в конфиге
- **Причина изменения личных данных** (`ufCrm8_1765129839889`) - ✅ используется в конфиге
- **Название новой компании** (`ufCrm8_1765129852733`) - ✅ используется в конфиге
- **Сайт новой компании** (`ufCrm8_1765129865270`) - ✅ используется в конфиге
- **ИНН новой компании** (`ufCrm8_1765129879057`) - ✅ используется в конфиге
- **Телефон новой компании** (`ufCrm8_1765129911053`) - ✅ используется в конфиге
- **Причина изменения данных о компании** (`ufCrm8_1765129926226`) - ✅ используется в конфиге
...
- **Название организации конечного заказчика** (`ufCrm6_1765127937187`) - ✅ используется
- **Название/тип объекта** (`ufCrm6_1765128017068`) - ✅ используется
- **Тип системы** (`ufCrm6_1765295738609`) - ✅ используется (множественное поле)
- **Адрес объекта** (`ufCrm6_1765128070976`) - ✅ используется
- **Дата реализации проекта** (`ufCrm6_1765128232432`) - ✅ используется
- **Тип запросов** (`ufCrm6_1765128261855`) - ✅ используется (добавлено 10.12.2025)
- **Перечень оборудования** (`ufCrm6_1765299780`) - ✅ используется (добавлено 10.12.2025, файл)
- **Возможные конкуренты** (`ufCrm6_1765128315359`) - ✅ используется (добавлено 10.12.2025)
- **Маркетинговая скидка** (`ufCrm6_1765128343798`) - ✅ используется (добавлено 10.12.2025, чекбокс)
- **Техническое описание** (`ufCrm6_1765360431193`) - ✅ используется (добавлено 10.12.2025, многострочный текст)
