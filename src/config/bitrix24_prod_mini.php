...
return [
    ...
    'bitrix24' => [
        ...
        'email_business_process_id' => 556, // ID бизнес-процесса для отправки email контакту о создании ЛК
        'first_auth_business_process_id' => 614, // ID бизнес-процесса для первой авторизации пользователя
    ],
    ...
    // Настройки очереди обработки вебхуков
    'queue' => [
        'batch_size' => 10, // Количество задач, обрабатываемых за одну итерацию
        'max_attempts' => 3, // Максимальное количество попыток обработки задачи
        'idle_sleep_time' => 30, // Время ожидания при отсутствии задач (секунды)
        'queue_file' => __DIR__ . '/../data/webhook_queue.json', // Путь к файлу очереди
