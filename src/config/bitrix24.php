...
return [
    ...
    'bitrix24' => [
        ...
        'email_business_process_id' => 31, // ID бизнес-процесса для отправки email контакту о создании ЛК
    ],
    ...
    'field_mapping' => [
        'contact' => [
            ...
            'agent_contract_status' => 'UF_CRM_1765115950388', // Статус "Агентский договор" (п.3.6) - список с заданными значениями
        ...
        'company' => [
            ...
            'partner_contract_status' => 'UF_CRM_1765116408407', // Статус "Партнерский договор" (п.3.7) - список с заданными значениями
